...
<head>
    ...
    and healthy meals to as many people as possible.">
...
<body>
    <header id="top">
        <nav>
            <div class="row">
                <a href="#top"><img src="resources/img/logo-white.png" alt="Omnifood logo" class="logo"></a>
                <a href="#top"><img src="resources/img/logo.png" alt="Omnifood logo" class="logo-black"></a>
                ...
                <a class="mobile-nav-icon js--mobile-nav"><i class="ion-navicon-round"></i></a>
            </div>
        </nav>
    ...
    <section class="section-steps" id="works">
        ...
        <div class="row">
            ...
            <div class="col span-1-of-2 steps-box clearfix">
                ...
                <a href="#" class="btn-app">
                    <img src="resources/img/download-app-android.png" alt="Play store">
                </a>
            </div>
        </div>
    </section>
